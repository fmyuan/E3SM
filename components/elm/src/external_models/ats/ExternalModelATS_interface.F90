module ExternalModelATS_interface
  ...
  interface
    ...
    subroutine ats_get_mesh_info2(ats, ncols_local, ncols_global, nlevgrnd, dzs, areas, lats, lons) bind(C, name="ats_get_mesh_info2")
      ...
      real(c_double), intent(inout) :: lats(*) ! array of size ncols_local
      real(c_double), intent(inout) :: lons(*) ! array of size ncols_local
