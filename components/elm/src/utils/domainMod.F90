...
!------------------------------------------------------------------------------
  ...
  call mpi_gatherv(domain_loc%xCell, domain_loc%ns, MPI_REAL8, &
                  domain_global%xCell, ns_rbuf, ns_displ, MPI_REAL8, 0, mpicom, ier)
  call mpi_bcast(domain_global%xCell, domain_global%ns, MPI_REAL8, 0, mpicom, ier)

  call mpi_gatherv(domain_loc%yCell, domain_loc%ns, MPI_REAL8, &
                  domain_global%yCell, ns_rbuf, ns_displ, MPI_REAL8, 0, mpicom, ier)
  call mpi_bcast(domain_global%yCell, domain_global%ns, MPI_REAL8, 0, mpicom, ier)

  call mpi_gatherv(domain_loc%stdev_elev, domain_loc%ns, MPI_REAL8, &
                  domain_global%stdev_elev, ns_rbuf, ns_displ, MPI_REAL8, 0, mpicom, ier)
  call mpi_bcast(domain_global%stdev_elev, domain_global%ns, MPI_REAL8, 0, mpicom, ier)

  call mpi_gatherv(domain_loc%sky_view, domain_loc%ns, MPI_REAL8, &
                  domain_global%sky_view, ns_rbuf, ns_displ, MPI_REAL8, 0, mpicom, ier)
  call mpi_bcast(domain_global%sky_view, domain_global%ns, MPI_REAL8, 0, mpicom, ier)

  call mpi_gatherv(domain_loc%terrain_config, domain_loc%ns, MPI_REAL8, &
                  domain_global%terrain_config, ns_rbuf, ns_displ, MPI_REAL8, 0, mpicom, ier)
  call mpi_bcast(domain_global%terrain_config, domain_global%ns, MPI_REAL8, 0, mpicom, ier)

  call mpi_gatherv(domain_loc%sinsl_cosas, domain_loc%ns, MPI_REAL8, &
                  domain_global%sinsl_cosas, ns_rbuf, ns_displ, MPI_REAL8, 0, mpicom, ier)
  call mpi_bcast(domain_global%sinsl_cosas, domain_global%ns, MPI_REAL8, 0, mpicom, ier)

  call mpi_gatherv(domain_loc%sinsl_sinas, domain_loc%ns, MPI_REAL8, &
                  domain_global%sinsl_sinas, ns_rbuf, ns_displ, MPI_REAL8, 0, mpicom, ier)
  call mpi_bcast(domain_global%sinsl_sinas, domain_global%ns, MPI_REAL8, 0, mpicom, ier)
