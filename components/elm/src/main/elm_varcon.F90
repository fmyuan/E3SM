module elm_varcon
 ...
 !real(r8), parameter :: nitrif_n2o_loss_frac = 0.02_r8  ! fraction of N lost as N2O in nitrification (Parton et al., 2001)
  ...
  !------------------------------------------------------------------
  ! (Non-tunable) Constants in Enhanced Weathering submodule, not included in parameter inputs
  !------------------------------------------------------------------
  ...
  ! molar mass of different molecules of interest, g/mol, not provided by users
  ...
  real(r8) :: D_h        = 9.310e-9_r8 ! 3e-14_r8 ! 9.310e-9_r8 ! diffusion coefficient of H+ in water (m2/s)
  real(r8) :: passivation_phi  = 0.2_r8 ! 0.2 ! 0.002 ! 0.2! 1 ! assumed porosity of the passivation layer
