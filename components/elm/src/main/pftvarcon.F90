module pftvarcon
  ...
  real(r8), allocatable :: needleleaf(:)        ! needle-leaf flag (0 or 1)
  real(r8), allocatable :: nonvascular(:)       ! nonvascular plant lifeform flag (0 or 1-moss or 2-lichen)
  real(r8), allocatable :: nfixer(:)            ! N-fixer flag (0 or 1)
  !----------------------F.-M. Yuan (2018-03-23): user-defined parameter file ---------------------------------------------------------------------
