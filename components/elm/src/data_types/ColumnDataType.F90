  ...
  subroutine col_pf_clean(this)
   ...
   subroutine col_mf_init(this, begc, endc)
      ...
      call hist_addfld2d (fname='PRIMARY_PROTON_FLUX_vr',  units='kg m-2 s-1', type2d='levgrnd', &
         avgflag='A', long_name='rate at which the primary reaction product H+ (vertically resolved)', &
      ...
      call hist_addfld1d (fname='PRIMARY_PROTON_FLUX',  units='kg m-2 s-1', &
         avgflag='A', long_name='rate at which the primary reaction product H+', &
      ...
      do c = begc,endc
         ...
         !if (lun_pp%itype(l)==istsoil .or. lun_pp%itype(l)==istcrop) then
            ...
            this%cec_limit_vr                   (c,1:mixing_layer,1:ncations ) = 1._r8
            this%proton_limit_vr                (c,1:mixing_layer            ) = 1._r8
            this%flux_limit_vr                  (c,1:mixing_layer,1:ncations ) = 1._r8
